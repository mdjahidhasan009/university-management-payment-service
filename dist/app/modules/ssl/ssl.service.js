...
const initPayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            // success_url: `${config.frontendUrl}/payments?status=success`,
            // fail_url: `${config.frontendUrl}/payments?status=error`,
            // cancel_url: `${config.frontendUrl}/payments?status=warning`,
            ipn_url: `${config_1.default.apiGatewayUrl}/payments/webhook`,
            shipping_method: 'N/A',
